...
# xiaoandx comitizen-practice-demo % 
```
...
查看提交信息
```bash
xiaoandx comitizen-practice-demo % git log
commit caae82ec7beb66423f190ab86a6343447b250046 (HEAD -> main)
Author: WEI.ZHOUO <wei.zhou@ccssttcn.com>
...
```bash
xiaoandx comitizen-practice-demo % git cz
cz-cli@4.2.4, cz-conventional-changelog@3.2.0
# ? Select the type of change that you're committing: fix:      A bug fix
...
git add .
git commit -m 'xx'
xiaoandx comitizen-practice-demo % git commit -m 'xxx'
# ⧗   input: xxx
...
```bash
xiaoandx comitizen-practice-demo % npm version 0.4.0 -m 'feat(version):0.4.0 tag remark'
v0.4.0
xiaoandx comitizen-practice-demo % git log
...
```bash
xiaoandx comitizen-practice-demo % npm run release
