...
{
    /// <summary>
    /// C# Operate Excel tools class
    /// </summary>
    public class ExcelUtils
    {
        /// <summary>
        /// Write excel or save excel
        /// </summary>
        /// <param name="FileName">excel file name</param>
        /// <param name="data">save data in DataTable</param>
        ...
        /// <returns></returns>
        public string ColCoord(string start, int num)
        {
            int Dif = start[0] - 'A';
            int ColNum = num + Dif;
        ...
        public void ReadExcel(ISheet sheet, IFormulaEvaluator evaluator, DataGridView dataGridView)
        {
            ...
            {
                //Debug.WriteLine($"{ColCoord("A", j)}1");
        ...
        /// open read CSV
        /// </summary>
        /// <param name="fullFileName">CSV file name</param>
        ...
        /// <returns>DataTable</returns>
        public DataTable OpenCSV(string fullFileName, int firstRow = 0, int firstColumn = 0, int getRows = 0, int getColumns = 0, bool haveTitleRow = true)
        {
